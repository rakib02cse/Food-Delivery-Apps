...
import 'package:foodie/compnents/restuarent.dart';
import 'package:foodie/constats/color.dart';
import 'package:foodie/constats/constants.dart';
import 'package:foodie/dashboard/home.dart';
import 'package:foodie/model/panda_pick_model/pandaPickHelper.dart';
import 'package:foodie/model/panda_pick_model/pandaPickItemModel.dart';
                         ...
                         child: Stack(
                           ...
                           children: const [
                             ...
                             Positioned(
                                 bottom: 15,
                                 left: 0,
                                 child: Text('Foodiemart' , style: TextStyle(color: blackColor , fontFamily: Bold, fontSize: 18 ),)),
                             Positioned(
                                 bottom: 0,
                                 left: 0,
                              child: Text('Foodie 20 for 15% off' , style: TextStyle(color: blackColor , fontWeight: FontWeight.w500 ,height:1 , fontFamily: Medium, fontSize: 14  ))),
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Text('Upto 45% off' , style: TextStyle(color: blackColor , fontWeight: FontWeight.w500 ,height:1 , fontFamily: Medium, fontSize: 14  )),
